...
<div >
  <main class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      <h6 class="heading">Enter Other Activities Details</h6>
...
<div class="flip-card" 	style="padding-bottom: 200px;     margin-bottom: -88px;">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
      ...
      <p>Note : The certificate file name should be saved as srno_rollno. eg: Your first activity certificate filename will be 1_<?php 
  if(isset($_SESSION['username'])){ $usersData = getUsersData(getId($_SESSION['username'])); echo $usersData['rollno']; } ?>, Second activity certificate filename will be 2_<?php if(isset($_SESSION['username'])){ $usersData = getUsersData(getId($_SESSION['username'])); echo $usersData['rollno']; } ?>.</p>
    </div>
  </div>
</div>    
