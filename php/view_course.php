...
$ed=$_POST['edate'];
$sql = "select rollno,name,name_c,insti,start_date,end_date from course WHERE start_date>='$sd' AND end_date<='$ed'";
...
{  
  ...
  <table style=" width: 192%;">
        ...
        <tr><th>&nbsp&nbspROLL NO&nbsp&nbsp</th><th>&nbsp&nbspNAME&nbsp&nbsp</th><th>&nbsp&nbspCOURSE NAME&nbsp&nbsp</th><th>&nbsp&nbspINSTITUTE/WEBSITE&nbsp&nbsp</th><th>&nbsp&nbspSTART&nbsp&nbspDATE&nbsp&nbsp</th><th>&nbsp&nbspEND&nbsp&nbspDATE&nbsp&nbsp</th></span></tr>
...
?>
 ...
 <br><br>
        ...
        $sql = "select rollno,name,name_c,insti,start_date,end_date from course";
...
$total_pages_sql = "SELECT COUNT(*) FROM course";
        ...
        $sql = "SELECT rollno,name,name_c,insti,start_date,end_date FROM course order by rollno LIMIT $offset, $no_of_records_per_page";
        $result = mysqli_query($conn,$sql);
  ?>
