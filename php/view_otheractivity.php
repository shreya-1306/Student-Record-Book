...
$ed=$_POST['edate'];
$sql = "select rollno,name_act,cond_by,start_date,end_date from other WHERE start_date>='$sd' AND end_date<='$ed'";
...
<?php 
        ...
        $sql = "select rollno,name_act,cond_by,start_date,end_date from other";
      $result=mysqli_query($conn,$sql);
if ($result->num_rows > 0)
{  
