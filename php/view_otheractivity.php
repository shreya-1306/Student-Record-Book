...
<span style="color: white;    font-size: 24px;">OTHER ACTIVITIES</span><br><br>
...
$ed=$_POST['edate'];
$sql = "select rollno,name,name_act,cond_by,start_date,end_date from other WHERE start_date>='$sd' AND end_date<='$ed'";
...
{  
  ...
  <table style=" width: 192%;" >
        <tr><th>&nbsp&nbspROLL&nbsp&nbspNO&nbsp&nbsp</th><th>&nbsp&nbspNAME&nbsp&nbsp</th><th>&nbsp&nbspNAME&nbsp&nbspOF&nbsp&nbspACTIVITY&nbsp&nbsp</th><th>&nbsp&nbspCONDUCTED&nbsp&nbspBY&nbsp&nbsp</th><th>&nbsp&nbspSTART&nbsp&nbspDATE&nbsp&nbsp</th><th>&nbsp&nbspEND&nbsp&nbspDATE&nbsp&nbsp</th></span></tr>
...
<?php 
        ...
        $sql = "select rollno,name,name_act,cond_by,start_date,end_date from other";
      $result=mysqli_query($conn,$sql);
if ($result->num_rows > 0)
{  
...
$total_pages_sql = "SELECT COUNT(*) FROM other";
        ...
        $sql = "select rollno,name,name_act,cond_by,start_date,end_date from other order by rollno LIMIT $offset, $no_of_records_per_page";
        $result = mysqli_query($conn,$sql);
