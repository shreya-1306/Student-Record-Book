...
<div class="flip-card" 	style="padding-bottom: 200px;     margin-bottom: -88px;">
  ...
  if(isset($_SESSION['username'])){ $usersData = getUsersData(getId($_SESSION['username'])); echo $usersData['rollno']; } ?>, Second competition certificate filename will be 2_<?php if(isset($_SESSION['username'])){ $usersData = getUsersData(getId($_SESSION['username'])); echo $usersData['rollno']; } ?>.</p>
    </div>
  </div>
</div>    
